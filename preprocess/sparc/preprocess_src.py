...
def parse_args():
    ...
    parser.add_argument('--train_file', type=str, default="data/original_data/sparc/train.json")
    parser.add_argument('--dev_file', type=str, default="data/original_data/sparc/dev.json")
    parser.add_argument('--preprocessed_train_file', type=str, default="data/preprocessed_data/sparc/symlink_star/preprocessed_train.json")
    parser.add_argument('--preprocessed_dev_file', type=str, default="data/preprocessed_data/sparc/symlink_star/preprocessed_dev.json")
    parser.add_argument('--comment_cache_train_file', type=str, default="data/preprocessed_data/sparc/comment_cache_train.json")
    parser.add_argument('--comment_cache_dev_file', type=str, default="data/preprocessed_data/sparc/comment_cache_dev.json")
    parser.add_argument('--table_path', type=str, default="data/original_data/sparc/tables.json")
