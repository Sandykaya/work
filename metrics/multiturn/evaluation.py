...
from metrics.multiturn.process_sql import get_schema, Schema, get_sql
from metrics.multiturn.exec_eval import eval_exec_match
...
def evaluate(gold, predict, db_dir, etype, kmaps, plug_value, keep_distinct, progress_bar_for_each_datapoint):
    ...
    if etype == 'match': return {'exact': scores['all']['exact']}
                  ...
                  'in_exact':scores['joint_all']['exact'], 'in_exec': scores['joint_all']['exec'],
                  'results': results}
